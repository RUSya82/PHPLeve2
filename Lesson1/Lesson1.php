...
//$a1 = new A();
//$a2 = new A();
//$a1->foo();   - т.к. преинкремент, то выведет 1
//$a2->foo();   - выведет 2, т.к. $x - статический, а после вызова в предыдущей строке оон был увеличен на единицу
//$a1->foo();
//$a2->foo();

//Что он выведет на каждом шаге? Почему?
//Ответ: выведет 1234, т.к. $x - статическая переменная и существует в контексте класса A
//------------------------------------------------ Задание №6 -----------------------------------------------//
...
$b1 = new B();
$a1->foo();     - выведет 1
$b1->foo();     - выведет 1, т.к. хоть класс B и наследник класса А, но у него своя статическая $x
$a1->foo();     - выведет 2
$b1->foo();      - выведет 2
*/
//----------------------------- Задание №7 ---------------------------------------------------------------//
...
Что он выведет на каждом шаге? Почему?*/
// Ответ: выведет то же самое, что и в предыдущем примере, т.к. отличие только в синтаксисе
/**/